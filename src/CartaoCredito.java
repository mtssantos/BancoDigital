public class CartaoCredito {
    ...
    public void compra(float valor){
        if (valor <= this.limCred - this.saldoDips) { // verifica se a compra é possível dentro do limite de crédito
            this.saldoDips += valor; // adiciona o valor da compra ao saldo devido
